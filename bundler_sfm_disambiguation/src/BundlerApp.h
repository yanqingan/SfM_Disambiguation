...
public:
	...
	/* Compute a set of particular tracks that explain the matches*/
    void ComputeConstraintTracks(int new_image_start = 0, int track_degree = 3);    // qingan

    /* Here is the declaration for disambiguation */
    void Disambiguate(float coverage_thres = 0.6f, float score_thres = 0.1f,
    	int new_image_start = 0, int track_degree = 3);    // qingan

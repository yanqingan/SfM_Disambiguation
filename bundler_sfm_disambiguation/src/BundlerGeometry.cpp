                                             ...
                                             int new_image_start) 
{
	...
	ReadGeometricConstraints(filename);
		...
		ComputeConstraintTracks(new_image_start, track_degree);    // qingan
		/* End of setting */
...
#endif
        /* Here is the main process of disambiguation */
		bool need_disambiguat = true;
		if (need_disambiguat)
		{
	    	Disambiguate(coverage, score_thres, new_image_start, track_degree);
		}
